...
public class Areas {
    private int area_id;
    boolean isdirty;  // burda o alanın kirliliğini kontrol edip temizleme fonksiyonunu çağıracaktır
    ...
    public void JoinClassroom(Courses x,Student y) {   // öğrencinin derse girip girmediğini kontrol eden fonksiyon
        ...
        y.setIternal(y.getIternal()+1);             // ayrıca öğrenci notuna bir puan ekler. derse geldiği için
    }
